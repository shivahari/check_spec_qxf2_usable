...
if __name__ == "__main__":
    ...
    for spec in os.listdir(openapi_spec_dir):
        if spec:
            spec_file = os.path.join(os.path.join(os.path.pardir, openapi_spec_dir), spec)
            logger.warning(f"Using spec file: {spec_file}")
            try:
